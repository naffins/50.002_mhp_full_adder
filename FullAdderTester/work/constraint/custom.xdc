...
set_property PACKAGE_PIN P10 [get_ports {out_a}]
set_property IOSTANDARD LVCMOS33 [get_ports {out_a}]
set_property PACKAGE_PIN T13 [get_ports {out_b}]
set_property IOSTANDARD LVCMOS33 [get_ports {out_b}]
set_property PACKAGE_PIN R13 [get_ports {out_ci}]
set_property IOSTANDARD LVCMOS33 [get_ports {out_ci}]
set_property PACKAGE_PIN N11 [get_ports {in_s}]
set_property IOSTANDARD LVCMOS33 [get_ports {in_s}]
set_property PULLDOWN true [get_ports {in_s}]
set_property PACKAGE_PIN T12 [get_ports {in_co}]
set_property IOSTANDARD LVCMOS33 [get_ports {in_co}]
set_property PULLDOWN true [get_ports {in_co}]
